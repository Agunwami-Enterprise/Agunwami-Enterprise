...
export default function PartnershipsPage() {
  ...
  return (
    <main className="flex flex-col items-center w-full">
      <Section className="relative flex flex-col justify-between min-h-[100dvh] bg-partnerships-hero dark:bg-partnerships-hero-dark bg-cover bg-center bg-no-repeat pt-28 md:pt-32 pb-16">
              ...
              <div className="bg-white dark:bg-[#1C1C1C] shadow-[0_10px_40px_-15px_rgba(0,0,0,0.1)] dark:shadow-none rounded-3xl p-6 md:p-10 relative overflow-hidden h-full group hover:shadow-[0_20px_50px_-15px_rgba(0,0,0,0.15)] dark:hover:shadow-none transition-all duration-500 border border-gray-100/50 dark:border-white/10">
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <div className="space-y-2 py-2 mb-2">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 leading-relaxed border-b border-gray-300 dark:border-white/10 pb-4">
